...
public class Holding {
	...
	public void setCurrentValue(BigDecimal currentValue) {
		this.currentValue = currentValue.setScale(4,  BigDecimal.ROUND_DOWN);
	}
	...
	public void addOrder(Order order) {
		...
		if (orders.contains(order)) {
			...
			if (order.getOrderType().equals(OrderType.BUY)) {
				...
				setPurchaseValue(
						getPurchaseValue().add(order.getPrice().multiply(new BigDecimal(order.getQuantity()))));
	...
	public String toString() {
		...
		builder.append("Holding [id=").append(id).append(", symbol=").append(symbol).append(", quantity=")
				.append(quantity).append(", purchasePrice=").append(purchaseValue).append(", sellPrice=")
				.append(sellValue).append(", orders=").append(orders).append(", currentValue=").append(currentValue)
				.append("]");
